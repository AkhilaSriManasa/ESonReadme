...
# cf = sys.argv[2]
# correlated_features = split(',')
# correlated_features = sys.argv[2]


df = pd.read_csv("Features_"+language+".csv")
...
# feature_names = np.delete(feature_name, np.where(feature_name == [correlated_features]), axis=0)
# print del_arr
print(feature_names)
# feature_names = ['List','Animation','Video','Table','Links','Project','Inline', 'Code']
